...
## Mapa repo
- `config/config.yaml` — JEDYNY plik, który zwykle edytuje użytkownik (odbiorca, liga, Fortuna, limity).
...
2. **Tylko rekomendacje.** Nie logujemy się do kicktippa/Fortuny i nie wysyłamy typów za użytkownika.
